        ...
        <section className="py-6 sm:py-8 bg-gradient-to-b from-yellow-50 to-white">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
              {Object.entries(
                t("services.filter", { returnObjects: true })
              ).map(([key, label]) => (
                <button
                  key={key}
            ...
            ${
              activeTab === key
                ...
                : "bg-white text-gray-700 border border-yellow-400 hover:bg-yellow-500 hover:text-white"
            }`}
                >
                  {label}
                </button>
          ...
          <div className="container mx-auto px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex flex-wrap grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                {t("services.whyChooseUs.items", { returnObjects: true }).map(
                  (item, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gray-50 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  {t("services.forms.formItems", { returnObjects: true }).map(
                    (form, index) => (
                      <div
                        key={index}
                      ...
                      >
                        <h4 className="font-semibold text-sm sm:text-base text-[#D4A017]">
                          {form.name}
                        </h4>
